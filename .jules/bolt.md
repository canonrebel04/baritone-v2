...
## 2025-05-21 - AStar Inner Loop Invariant Calculation Hoisting
**Learning:** In AStarPathFinder, recalculating invariant properties of a base node (e.g., node.x >> 4 for chunk coordinate mapping) repeatedly inside the innermost adjacent movement loop is extremely wasteful. Hoisting this outside the loop saves millions of bitwise operations per pathfinding segment.
**Action:** Always identify and hoist invariant calculations out of innermost tight loops (like pathing adjacency evaluations).
