...
## 2026-08-16 - Hoisting Invariants
**Learning:** Hoisting node-specific invariants out of innermost pathing loops saves significant CPU cycles.
**Action:** Always check inner loops for invariant node property lookups.
