...
public final class BinaryHeapOpenSet implements IOpenSet {
    ...
    public final void update(PathNode val) {
        ...
        // ⚡ Bolt Optimization: Half-exchange pattern in sift-up.
        // We defer assigning array[index] = val and val.heapPosition = index
        // until the end of the loop. Impact: Minimizes redundant memory stores
        // during priority queue updates.
    ...
    public final PathNode removeLowest() {
        ...
        // ⚡ Bolt Optimization: Half-exchange pattern in sift-down.
        // Similar to update(), we defer storing `val` in the array until the
        // correct position is found, avoiding unnecessary swaps.
        int index = 1;
        int smallerChild = 2;
        double cost = val.combinedCost;
