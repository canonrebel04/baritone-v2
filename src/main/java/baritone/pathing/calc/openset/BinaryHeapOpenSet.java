...
public final class BinaryHeapOpenSet implements IOpenSet {
    ...
    public final void update(PathNode val) {
        // Bolt Optimization: Half-exchange sift-up
        // Instead of swapping elements at each step, we only pull parents down
        // and do a single assignment for 'val' at the end of the shifting.
    ...
    public final PathNode removeLowest() {
        ...
        // Bolt Optimization: Half-exchange sift-down
        // Similar to sift-up, we don't store 'val' until we find its final position.
        array[size] = null;
        size--;
